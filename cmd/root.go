...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfg.BaseAddress, "baseAddress", "http://0.0.0.0:6443", "Format: <http | https>://domainOrIPAddress[:port]. Example: https://console.hypercloud.com.")
	...
	rootCmd.PersistentFlags().StringVar(&cfg.PrometheusEndpoint, "promethues-endpoint", "", "URL of the prometheus endpoint")
