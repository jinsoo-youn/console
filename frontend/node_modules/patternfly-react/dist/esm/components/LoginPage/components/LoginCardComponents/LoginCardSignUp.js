...
const LoginCardSignUp = (_ref) => {
  ...
  return label && React.createElement("div", _extends({}, props, {
    className: classNames('login-pf-signup', className)
  }), React.createElement("p", null, label, React.createElement(Link, link)));
};
