...
export const TABLE_SORT_DIRECTIONS = [TABLE_SORT_DIRECTION.ASC, TABLE_SORT_DIRECTION.DESC, TABLE_SORT_DIRECTION.DEFAULT]; // Reactabular sorting order allows you to specifiy sort asc/desc only and removes
