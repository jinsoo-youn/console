...
const NotificationDrawerEmptyState = (_ref) => {
  let {
    title,
    className
  } = _ref,
  ...
  return React.createElement(EmptyState, null, React.createElement(EmptyStateIcon, {
    name: "info"
  }), React.createElement(EmptyStateTitle, null, title));
};
