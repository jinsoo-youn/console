...
var SocialLoginCard = function SocialLoginCard(_ref) {
  ...
  return _react["default"].createElement(_LoginCard["default"], _extends({}, props, {
    className: (0, _classnames["default"])('login-pf-accounts', className)
  }), children);
};
