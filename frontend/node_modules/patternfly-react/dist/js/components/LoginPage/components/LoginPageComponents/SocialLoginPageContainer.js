...
var SocialLoginPageContainer = function SocialLoginPageContainer(_ref) {
  ...
  return _react["default"].createElement(_LoginPageContainer["default"], _extends({}, props, {
    className: "".concat(className, " login-pf-page-accounts")
  }), children);
};
...
var _default = SocialLoginPageContainer;
