...
var InfoTipToggle = /*#__PURE__*/function (_React$Component) {
  _inherits(InfoTipToggle, _React$Component);

  function InfoTipToggle() {
    _classCallCheck(this, InfoTipToggle);

    return _possibleConstructorReturn(this, _getPrototypeOf(InfoTipToggle).apply(this, arguments));
  }
...
_defineProperty(InfoTipToggle, "propTypes", _objectSpread({}, _Dropdown.Dropdown.propTypes, {
