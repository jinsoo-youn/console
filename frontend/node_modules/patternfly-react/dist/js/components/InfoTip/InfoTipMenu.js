...
var InfoTipMenu = /*#__PURE__*/function (_React$Component) {
  _inherits(InfoTipMenu, _React$Component);

  function InfoTipMenu() {
    _classCallCheck(this, InfoTipMenu);

    return _possibleConstructorReturn(this, _getPrototypeOf(InfoTipMenu).apply(this, arguments));
  }
  ...
  _createClass(InfoTipMenu, [{
    ...
    value: function render() {
      ...
      var infoTipMenuClass = (0, _classnames["default"])('dropdown-menu', 'infotip', 'bottom-right', className);
...
_defineProperty(InfoTipMenu, "propTypes", {
  ...
  bsRole: _propTypes["default"].string,
