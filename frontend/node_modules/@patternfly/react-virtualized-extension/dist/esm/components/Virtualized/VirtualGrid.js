...
_defineProperty(VirtualGrid, "propTypes", {
  ...
  autoContainerWidth: _pt.bool,
  autoHeight: _pt.bool,
  autoWidth: _pt.bool,
  cellRenderer: _pt.any.isRequired,
  cellRangeRenderer: _pt.any,
  className: _pt.string,
  columnCount: _pt.number.isRequired,
  columnWidth: _pt.any.isRequired,
  containerProps: _pt.any,
  containerRole: _pt.string,
  containerStyle: _pt.any,
  deferredMeasurementCache: _pt.any,
  estimatedColumnSize: _pt.number,
  estimatedRowSize: _pt.number,
  getScrollbarSize: _pt.func,
  height: _pt.number.isRequired,
  id: _pt.string,
  isScrolling: _pt.bool,
  isScrollingOptOut: _pt.bool,
  noContentRenderer: _pt.any,
  onScroll: _pt.func,
  onScrollbarPresenceChange: _pt.func,
  onSectionRendered: _pt.func
});
