(function (global, factory) {
  ...
  exports.CatalogItemHeader = undefined;
  ...
  const CatalogItemHeader = exports.CatalogItemHeader = _ref => {
    let {
      className = '',
      iconImg = null,
      iconClass = null,
    ...
    return React.createElement("header", _extends({
      className: (0, _classnames2.default)('catalog-item-header-pf', className)
    }, props), iconImg && React.createElement("img", {
      className: "catalog-item-header-pf-icon",
      src: iconImg,
      alt: ""
    }), !iconImg && iconClass && React.createElement("span", {
    ...
    }, title), vendor && React.createElement("h5", {
