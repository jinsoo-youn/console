(function (global, factory) {
  ...
  exports.VerticalTabsTab = undefined;
  ...
  const VerticalTabsTab = exports.VerticalTabsTab = _ref => {
    let {
      children = null,
      className = '',
      title = null,
    ...
    const classes = (0, _classnames2.default)('vertical-tabs-pf-tab', {
      active,
      'active-descendant': hasActiveDescendant,
      shown
    }, className);
    const linkClasses = (0, _classnames2.default)({
