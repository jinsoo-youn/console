(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "react", "@patternfly/react-core", "@patternfly/react-icons/dist/js/icons/expand-icon", "@patternfly/react-icons/dist/js/icons/expand-arrows-alt-icon", "@patternfly/react-icons/dist/js/icons/search-plus-icon", "@patternfly/react-icons/dist/js/icons/search-minus-icon", "@patternfly/react-styles/css/components/Topology/topology-controlbar.css"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("prop-types"), require("react"), require("@patternfly/react-core"), require("@patternfly/react-icons/dist/js/icons/expand-icon"), require("@patternfly/react-icons/dist/js/icons/expand-arrows-alt-icon"), require("@patternfly/react-icons/dist/js/icons/search-plus-icon"), require("@patternfly/react-icons/dist/js/icons/search-minus-icon"), require("@patternfly/react-styles/css/components/Topology/topology-controlbar.css"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propTypes, global.react, global.reactCore, global.expandIcon, global.expandArrowsAltIcon, global.searchPlusIcon, global.searchMinusIcon, global.topologyControlbar);
    global.undefined = mod.exports;
  }
})(this, function (exports, _propTypes, _react, _reactCore, _expandIcon, _expandArrowsAltIcon, _searchPlusIcon, _searchMinusIcon) {
  "use strict";
  ...
  var _expandArrowsAltIcon2 = _interopRequireDefault(_expandArrowsAltIcon);

  var _searchPlusIcon2 = _interopRequireDefault(_searchPlusIcon);

  var _searchMinusIcon2 = _interopRequireDefault(_searchMinusIcon);
  ...
  const defaultControlButtonsOptions = exports.defaultControlButtonsOptions = {
    zoomIn: true,
    zoomInIcon: React.createElement(_searchPlusIcon2.default, null),
    zoomInTip: 'Zoom In',
    ...
    zoomInHidden: false,
    zoomOut: true,
    zoomOutIcon: React.createElement(_searchMinusIcon2.default, null),
    zoomOutTip: 'Zoom Out',
    ...
    zoomOutHidden: false,
    fitToScreen: true,
    fitToScreenIcon: React.createElement(_expandArrowsAltIcon2.default, null),
    ...
    resetView: true,
    resetViewIcon: React.createElement(_expandIcon2.default, null),
  ...
  const TopologyControlBar = exports.TopologyControlBar = _ref => {
    ...
    const renderButton = button => {
      ...
      if (button.tooltip) {
        return React.createElement(_reactCore.Tooltip, {
          isContentLeftAligned: _reactCore.Tooltip.defaultProps.isContentLeftAligned,
    ...
    return React.createElement(_reactCore.Toolbar, _extends({
      className: className
    }, props), React.createElement(_reactCore.ToolbarGroup, null, controlButtons.map(button => button.hidden ? null : React.createElement(_reactCore.ToolbarItem, {
      key: button.id
