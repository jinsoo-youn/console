...
export const TopologyControlBar = (_ref) => {
  ...
  const renderButton = button => {
    ...
    if (button.tooltip) {
      return React.createElement(Tooltip, {
        isContentLeftAligned: Tooltip.defaultProps.isContentLeftAligned,
  ...
  return React.createElement(Toolbar, _extends({
    className: className
  }, props), React.createElement(ToolbarGroup, null, controlButtons.map(button => button.hidden ? null : React.createElement(ToolbarItem, {
    key: button.id
