...
var _Stack = require("@patternfly/react-core/dist/js/layouts/Stack/Stack");

var _StackItem = require("@patternfly/react-core/dist/js/layouts/Stack/StackItem");
...
var TopologyView = function TopologyView(_ref) {
  ...
  var containerClasses = 'pf-topology-container' + "".concat(sideBar ? ' pf-topology-container__with-sidebar' : '') + "".concat(sideBarOpen ? ' pf-topology-container__with-sidebar--open' : '');
