...
var _expandIcon = _interopRequireDefault(require("@patternfly/react-icons/dist/js/icons/expand-icon"));

var _expandArrowsAltIcon = _interopRequireDefault(require("@patternfly/react-icons/dist/js/icons/expand-arrows-alt-icon"));

var _searchPlusIcon = _interopRequireDefault(require("@patternfly/react-icons/dist/js/icons/search-plus-icon"));

var _searchMinusIcon = _interopRequireDefault(require("@patternfly/react-icons/dist/js/icons/search-minus-icon"));
...
var defaultControlButtonsOptions = {
  zoomIn: true,
  zoomInIcon: React.createElement(_searchPlusIcon["default"], null),
  zoomInTip: 'Zoom In',
  ...
  zoomInHidden: false,
  zoomOut: true,
  zoomOutIcon: React.createElement(_searchMinusIcon["default"], null),
  zoomOutTip: 'Zoom Out',
  ...
  zoomOutHidden: false,
  fitToScreen: true,
  fitToScreenIcon: React.createElement(_expandArrowsAltIcon["default"], null),
  ...
  resetView: true,
  resetViewIcon: React.createElement(_expandIcon["default"], null),
...
var TopologyControlBar = function TopologyControlBar(_ref2) {
  ...
  var renderButton = function renderButton(button) {
    var renderedButton = // eslint-disable-next-line @typescript-eslint/ban-ts-ignore
