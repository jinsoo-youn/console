...
class BaseStatusModal extends _utils__WEBPACK_IMPORTED_MODULE_5__["PromiseComponent"] {
    ...
    _submit(e) {
        ...
        switch (kind.kind) {
            ...
            case _models__WEBPACK_IMPORTED_MODULE_1__["CatalogServiceClaimModel"].kind: {
                const stat = this.state.status === 'Approved' ? 'Approve' : 'Reject';
                const promise = Object(_module_k8s__WEBPACK_IMPORTED_MODULE_2__["k8sUpdateApproval"])(kind, resource, 'status', [{ op: 'replace', path: '/status/status', value: stat }], 'PATCH');
                this.handlePromise(promise).then(this.successSubmit);
                break;
            }
            default: {
...
//# sourceMappingURL=status-modal-29b38c57a6c7892193f1.js.map