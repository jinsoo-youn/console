...
const RegistriesPage = Object(react_router_dom__WEBPACK_IMPORTED_MODULE_11__["withRouter"])(props => {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_factory__WEBPACK_IMPORTED_MODULE_4__["ListPage"], Object.assign({ title: t('COMMON:MSG_LNB_MENU_71'), createButtonText: t('COMMON:MSG_MAIN_CREATEBUTTON_1', { 0: t('COMMON:MSG_LNB_MENU_71') }), canCreate: true, createProps: createProps, ListComponent: Registries, rowFilters: filters, kind: kind }, props));
});
...
const NotaryLoader = props => {
    return react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_utils__WEBPACK_IMPORTED_MODULE_5__["AsyncComponent"], { loader: () => __webpack_require__.e(/*! import() */ 40).then(__webpack_require__.bind(null, /*! ./notary */ "./public/components/hypercloud/notary.tsx")).then(c => c.NotariesDetailsPage), kind: 'Notary', kindObj: _models_hypercloud__WEBPACK_IMPORTED_MODULE_6__["NotaryModel"], name: decodeURIComponent(props.obj.metadata.name), namespace: props.obj.metadata.namespace, match: props.match });
};
...
//# sourceMappingURL=registry-fa1b168a2d5c68bb0348.js.map