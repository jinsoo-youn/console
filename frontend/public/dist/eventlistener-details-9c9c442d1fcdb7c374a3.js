(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["eventlistener-details"],{

/***/ "./packages/dev-console/src/components/pipelines/EventListenerPage.tsx":
/*!*****************************************************************************!*\
  !*** ./packages/dev-console/src/components/pipelines/EventListenerPage.tsx ***!
  \*****************************************************************************/
...
/* harmony import */ var _resource_overview_DynamicResourceLinkList__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../resource-overview/DynamicResourceLinkList */ "./packages/dev-console/src/components/pipelines/resource-overview/DynamicResourceLinkList.tsx");
/* harmony import */ var _resource_overview_TriggerTemplateResourceLink__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../resource-overview/TriggerTemplateResourceLink */ "./packages/dev-console/src/components/pipelines/resource-overview/TriggerTemplateResourceLink.tsx");
...
const EventListenerDetails = ({ obj: eventListener }) => {
    const routeTemplates = Object(_utils_triggers__WEBPACK_IMPORTED_MODULE_5__["useEventListenerTriggerTemplateNames"])(eventListener) || [];
    const bindings = Object(_utils_triggers__WEBPACK_IMPORTED_MODULE_5__["getEventListenerTriggerBindingNames"])(eventListener);
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "co-m-pane__body" },
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_console_internal_components_utils__WEBPACK_IMPORTED_MODULE_1__["SectionHeading"], { text: "Event Listener Details" }),
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "row" },
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "col-sm-6" },
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_console_internal_components_utils__WEBPACK_IMPORTED_MODULE_1__["ResourceSummary"], { resource: eventListener })),
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "col-sm-6" },
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_resource_overview_TriggerTemplateResourceLink__WEBPACK_IMPORTED_MODULE_4__["default"], { namespace: eventListener.metadata.namespace, model: _models__WEBPACK_IMPORTED_MODULE_2__["TriggerTemplateModel"], links: routeTemplates }),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_resource_overview_DynamicResourceLinkList__WEBPACK_IMPORTED_MODULE_3__["default"], { links: bindings, namespace: eventListener.metadata.namespace, title: _models__WEBPACK_IMPORTED_MODULE_2__["TriggerBindingModel"].labelPlural })))));
};
/* harmony default export */ __webpack_exports__["default"] = (EventListenerDetails);
...
//# sourceMappingURL=eventlistener-details-9c9c442d1fcdb7c374a3.js.map