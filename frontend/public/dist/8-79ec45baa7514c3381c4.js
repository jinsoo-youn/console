...
const EditYAML_ = Object(react_redux__WEBPACK_IMPORTED_MODULE_5__["connect"])(stateToProps)(class EditYAML extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
        ...
        this.setState({ success: null, error: null }, () => {
            ...
            action(model, obj, newNamespace, newName)
                ...
                if (redirect) {
                    ...
                    if (!url) {
                        const path = lodash_es__WEBPACK_IMPORTED_MODULE_0__["isFunction"](this.props.resourceObjPath) ? this.props.resourceObjPath : _utils__WEBPACK_IMPORTED_MODULE_11__["resourceObjPath"];
    ...
    render() {
        ...
        const model = this.getModel(obj);
        const { samples, snippets } = model ? Object(_sidebars_resource_sidebar_samples__WEBPACK_IMPORTED_MODULE_14__["getResourceSidebarSamples"])(model, yamlSamplesList) : { samples: [], snippets: [] };
        ...
        return lodash_es__WEBPACK_IMPORTED_MODULE_0__["isFunction"](connectDropTarget) ? connectDropTarget(editYamlComponent) : editYamlComponent;
    }
});
...
//# sourceMappingURL=8-79ec45baa7514c3381c4.js.map