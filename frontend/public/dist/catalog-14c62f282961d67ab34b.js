        ...
        this.renderTile = (item) => {
            ...
            return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_patternfly_react_catalog_view_extension__WEBPACK_IMPORTED_MODULE_5__["CatalogTile"], Object.assign({ className: "co-catalog-tile", key: uid, onClick: () => this.openOverlay(item), title: tileName, badges: [
                    react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_patternfly_react_catalog_view_extension__WEBPACK_IMPORTED_MODULE_5__["CatalogTileBadge"], { key: "type" },
                        react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_patternfly_react_core__WEBPACK_IMPORTED_MODULE_4__["Badge"], { isRead: true }, filter === null || filter === void 0 ? void 0 : filter.label)),
...
class CatalogListPage extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    ...
    componentDidUpdate(prevProps) {
        ...
        if ((!prevProps.loaded && loaded) || !lodash_es__WEBPACK_IMPORTED_MODULE_1__["isEqual"](namespace, prevProps.namespace) || !lodash_es__WEBPACK_IMPORTED_MODULE_1__["isEqual"](serviceClasses, prevProps.serviceClasses) || !lodash_es__WEBPACK_IMPORTED_MODULE_1__["isEqual"](clusterServiceClasses, prevProps.clusterServiceClasses) || !lodash_es__WEBPACK_IMPORTED_MODULE_1__["isEqual"](templateMetadata, prevProps.templateMetadata) || !lodash_es__WEBPACK_IMPORTED_MODULE_1__["isEqual"](projectTemplateMetadata, prevProps.projectTemplateMetadata) || !lodash_es__WEBPACK_IMPORTED_MODULE_1__["isEqual"](imageStreams, prevProps.imageStreams) || !lodash_es__WEBPACK_IMPORTED_MODULE_1__["isEqual"](helmCharts, prevProps.helmCharts)) {
            const items = this.getItems();
            this.setState({ items });
        }
    }
    getItems() {
        ...
        const items = [...serviceClassItems, ...clusterServiceClassItems, ...imageStreamItems, ...templateItems, ...extensionItems, ...projectTemplateItems, ...helmChartItems];
        return lodash_es__WEBPACK_IMPORTED_MODULE_1__["sortBy"](items, 'tileName');
    }
    normalizeServiceClasses(serviceClasses) {
        ...
        return lodash_es__WEBPACK_IMPORTED_MODULE_1__["reduce"](serviceClasses, (acc, serviceClass) => {
            ...
            acc.push({
                ...
                tileImgUrl: tileImgUrl == 'example.com/example.gif' ? null : tileImgUrl,
                ...
                documentationUrl: lodash_es__WEBPACK_IMPORTED_MODULE_1__["get"](serviceClass, 'spec.externalMetadata.urlDescription'),
            });
            return acc;
        }, []);
    }
    normalizeClusterServiceClasses(clusterServiceClasses) {
        return lodash_es__WEBPACK_IMPORTED_MODULE_1__["reduce"](clusterServiceClasses, (acc, clusterServiceClass) => {
            ...
            //   return acc;
            // }
            const iconClass = Object(_catalog_item_icon__WEBPACK_IMPORTED_MODULE_12__["getServiceClassIcon"])(clusterServiceClass);
            const tileImgUrl = Object(_catalog_item_icon__WEBPACK_IMPORTED_MODULE_12__["getServiceClassImage"])(clusterServiceClass);
            // TODO : service class를 사용한 service instance 기획이 나오면 해당 페이지로 이동시켜주도록 href 수정하기
            // 지금은 cluster service class 선택하고 create 누르면 default네임스페이스의 서비스인스턴스생성 페이지로 이동하게 해놓음
            acc.push({
                obj: clusterServiceClass,
                kind: 'ClusterServiceClass',
                tileName: Object(_module_k8s__WEBPACK_IMPORTED_MODULE_7__["serviceClassDisplayName"])(clusterServiceClass),
                tileIconClass: tileImgUrl ? null : iconClass,
                tileImgUrl: tileImgUrl == 'example.com/example.gif' ? null : tileImgUrl,
                tileDescription: clusterServiceClass.spec.description,
                tileProvider: lodash_es__WEBPACK_IMPORTED_MODULE_1__["get"](clusterServiceClass, 'spec.externalMetadata.providerDisplayName'),
                ...
                supportUrl: lodash_es__WEBPACK_IMPORTED_MODULE_1__["get"](clusterServiceClass, 'spec.externalMetadata.supportUrl'),
                longDescription: lodash_es__WEBPACK_IMPORTED_MODULE_1__["get"](clusterServiceClass, 'spec.externalMetadata.longDescription'),
                documentationUrl: lodash_es__WEBPACK_IMPORTED_MODULE_1__["get"](clusterServiceClass, 'spec.externalMetadata.documentationUrl'),
            });
            return acc;
        }, []);
    }
...
const Catalog = Object(_reducers_features__WEBPACK_IMPORTED_MODULE_9__["connectToFlags"])(_console_shared__WEBPACK_IMPORTED_MODULE_5__["FLAGS"].OPENSHIFT, _console_shared__WEBPACK_IMPORTED_MODULE_5__["FLAGS"].SERVICE_CATALOG, ..._plugins__WEBPACK_IMPORTED_MODULE_14__["registry"].getDevCatalogModels().map(({ properties }) => properties.flag))(props => {
    ...
    const resources = [
        ...
        ...[
            {
                isList: true,
                kind: Object(_module_k8s__WEBPACK_IMPORTED_MODULE_7__["referenceForModel"])(_models__WEBPACK_IMPORTED_MODULE_13__["ServiceClassModel"]),
                namespaced: true,
                namespace,
                prop: 'serviceClasses',
            },
...
//# sourceMappingURL=catalog-14c62f282961d67ab34b.js.map