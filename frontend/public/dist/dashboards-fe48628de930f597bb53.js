...
const leftCards = [{ Card: _details_card__WEBPACK_IMPORTED_MODULE_4__["DetailsCard"] }, { Card: _inventory_card__WEBPACK_IMPORTED_MODULE_5__["InventoryCard"] }];
const rightCards = [{ Card: _activity_card__WEBPACK_IMPORTED_MODULE_7__["ActivityCard"] }];
...
/*!****************************************************************************************!*\
  !*** ./public/components/dashboard/dashboards-page/cluster-dashboard/details-card.tsx ***!
  \****************************************************************************************/
/*! exports provided: DetailsCard_, DetailsCard */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const DetailsCard_ = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps)(({ watchK8sResource, stopWatchK8sResource, openshiftFlag }) => {
    ...
    const [k8sVersion, setK8sVersion] = react__WEBPACK_IMPORTED_MODULE_0__["useState"]();
    const [k8sVersionError, setK8sVersionError] = react__WEBPACK_IMPORTED_MODULE_0__["useState"]();
    ...
    const k8sGitVersion = Object(_module_k8s__WEBPACK_IMPORTED_MODULE_13__["getK8sGitVersion"])(k8sVersion);
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_console_shared_src_components_dashboard_dashboard_card_DashboardCard__WEBPACK_IMPORTED_MODULE_5__["default"], { "data-test-id": "details-card" },
        ...
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_console_shared_src_components_dashboard_dashboard_card_DashboardCardBody__WEBPACK_IMPORTED_MODULE_6__["default"], { isLoading: Object(_reducers_features__WEBPACK_IMPORTED_MODULE_14__["flagPending"])(openshiftFlag) },
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_console_shared_src_components_dashboard_details_card_DetailsBody__WEBPACK_IMPORTED_MODULE_9__["default"], null, openshiftFlag ? (react__WEBPACK_IMPORTED_MODULE_0__["createElement"](react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null,
                ...
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_console_shared_src_components_dashboard_details_card_DetailItem__WEBPACK_IMPORTED_MODULE_10__["default"], { title: "Cluster ID", error: !!clusterVersionError || (clusterVersionLoaded && !clusterId), isLoading: !clusterVersionLoaded },
                    ...
                    window.SERVER_FLAGS.branding !== 'okd' && window.SERVER_FLAGS.branding !== 'azure' && react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_utils__WEBPACK_IMPORTED_MODULE_15__["ExternalLink"], { text: "OpenShift Cluster Manager", href: Object(_module_k8s__WEBPACK_IMPORTED_MODULE_13__["getOCMLink"])(clusterId) })),
                ...
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_console_shared_src_components_dashboard_details_card_DetailItem__WEBPACK_IMPORTED_MODULE_10__["default"], { title: "Update channel", isLoading: !clusterVersionLoaded && !clusterVersionError, error: !!clusterVersionError || (clusterVersionLoaded && !cvChannel), valueClassName: "co-select-to-copy" }, cvChannel))) : (react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_console_shared_src_components_dashboard_details_card_DetailItem__WEBPACK_IMPORTED_MODULE_10__["default"], { key: "kubernetes", title: t('SINGLE:MSG_OVERVIEW_MAIN_CARDDETAILS_1'), error: !!k8sVersionError || (k8sVersion && !k8sGitVersion), isLoading: !k8sVersion, valueClassName: "co-select-to-copy" }, k8sGitVersion))))));
});
...
const InventoryCard = () => {
    ...
    const replacementExtensions = Object(_console_plugin_sdk__WEBPACK_IMPORTED_MODULE_9__["useExtensions"])(_console_plugin_sdk__WEBPACK_IMPORTED_MODULE_9__["isDashboardsOverviewInventoryItemReplacement"]);
    const mergedItems = react__WEBPACK_IMPORTED_MODULE_0__["useMemo"](() => mergeItems(itemExtensions, replacementExtensions), [itemExtensions, replacementExtensions]);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_console_shared_src_components_dashboard_dashboard_card_DashboardCard__WEBPACK_IMPORTED_MODULE_1__["default"], { "data-test-id": "inventory-card" },
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_console_shared_src_components_dashboard_dashboard_card_DashboardCardHeader__WEBPACK_IMPORTED_MODULE_3__["default"], null,
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_console_shared_src_components_dashboard_dashboard_card_DashboardCardTitle__WEBPACK_IMPORTED_MODULE_4__["default"], null, t('SINGLE:MSG_OVERVIEW_MAIN_CARDCLUSTERINVENTORY_1'))),
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_console_shared_src_components_dashboard_dashboard_card_DashboardCardBody__WEBPACK_IMPORTED_MODULE_2__["default"], null, mergedItems.map(item => (react__WEBPACK_IMPORTED_MODULE_0__["createElement"](ClusterInventoryItem, { key: item.properties.model.kind, model: item.properties.model, mapper: item.properties.mapper, additionalResources: item.properties.additionalResources, useAbbr: item.properties.useAbbr, expandedComponent: item.properties.expandedComponent }))))));
};
...
const StatusCard = Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["connect"])(mapStateToProps)(({ k8sModels }) => {
    ...
    subsystems.forEach(subsystem => {
        if (Object(_console_plugin_sdk__WEBPACK_IMPORTED_MODULE_3__["isDashboardsOverviewHealthURLSubsystem"])(subsystem)) {
            ...
            healthItems.push({
                title: subsystem.properties.title,
                Component: react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_health_item__WEBPACK_IMPORTED_MODULE_20__["PrometheusHealthItem"], { subsystem: subsystem.properties, models: k8sModels }),
            });
        }
...
//# sourceMappingURL=dashboards-fe48628de930f597bb53.js.map