(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["basicauth-idp-form"],{

/***/ "./public/components/cluster-settings/basicauth-idp-form.tsx":
/*!*******************************************************************!*\
  !*** ./public/components/cluster-settings/basicauth-idp-form.tsx ***!
  \*******************************************************************/
/*! exports provided: DroppableFileInput, AddBasicAuthPage */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddBasicAuthPage", function() { return AddBasicAuthPage; });
...
class AddBasicAuthPage extends _utils__WEBPACK_IMPORTED_MODULE_6__["PromiseComponent"] {
    constructor() {
        super(...arguments);
        this.state = {
            name: 'basic-auth',
    ...
    addBasicAuthIDP(oauth, secretName, caName, dryRun) {
    ...
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "co-m-pane__body" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("form", { onSubmit: this.submit, name: "form", className: "co-m-pane__body-group co-m-pane__form" },
                ...
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("p", { className: "co-m-pane__explanation" }, "Basic authentication is a generic backend integration mechanism that allows users to authenticate with credentials validated against a remote identity provider."),
...
//# sourceMappingURL=basicauth-idp-form-ffa300db85f607b65003.js.map