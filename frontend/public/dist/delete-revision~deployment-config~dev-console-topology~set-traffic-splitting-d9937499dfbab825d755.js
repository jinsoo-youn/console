...
const EnvironmentPage = (props) => (react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_utils__WEBPACK_IMPORTED_MODULE_13__["AsyncComponent"], Object.assign({ loader: () => __webpack_require__.e(/*! import() */ 9).then(__webpack_require__.bind(null, /*! ./environment.jsx */ "./public/components/environment.jsx")).then((c) => c.EnvironmentPage) }, props)));
...
//# sourceMappingURL=delete-revision~deployment-config~dev-console-topology~set-traffic-splitting-d9937499dfbab825d755.js.map