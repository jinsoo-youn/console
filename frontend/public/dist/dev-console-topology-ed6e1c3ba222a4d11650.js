...
const Topology = ({ data, filters, application, namespace, serviceBinding, eventSourceEnabled, onSelectTab, }) => {
    ...
    react__WEBPACK_IMPORTED_MODULE_0__["useEffect"](() => {
        ...
        if (selectedIds.length > 0) {
            ...
            if (selectedEntity) {
                const visibleEntity = Object(_console_topology__WEBPACK_IMPORTED_MODULE_7__["isNode"])(selectedEntity)
                    ? selectedEntity
...
const Controller = ({ render, resources, loaded, loadError, utils, namespace, serviceBinding, trafficData, }) => {
    ...
    return render({
        ...
        namespace,
        serviceBinding,
        data: loaded && helmResourcesMap
            ? Object(_data_transforms_data_transformer__WEBPACK_IMPORTED_MODULE_8__["transformTopologyData"])(resources, _topology_utils__WEBPACK_IMPORTED_MODULE_9__["allowedResources"], utils, trafficData, helmResourcesMap)
            : null,
    });
};
...
const DataControllerStateToProps = (state) => {
    const resourceList = _console_internal_plugins__WEBPACK_IMPORTED_MODULE_3__["registry"]
        .getOverviewCRDs()
...
const TopologyPage = ({ match }) => {
    ...
    react__WEBPACK_IMPORTED_MODULE_0__["useEffect"](() => setTopologyActiveView(showListView && !showGraphView ? 'list' : 'graph'), [
        showListView,
        showGraphView,
    ]);
...
const ConnectedTopologyHelmReleasePanel = ({ helmRelease, selectedDetailsTab, onClickTab, }) => {
    ...
    const detailsComponent = !secret
        ? () => (react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_console_internal_components_utils__WEBPACK_IMPORTED_MODULE_3__["StatusBox"], { loaded: true, loadError: { message: `Unable to find resource for ${helmRelease.getLabel()}` } }))
        : _console_internal_components_utils__WEBPACK_IMPORTED_MODULE_3__["navFactory"].details(_helm_details_overview_HelmReleaseOverview__WEBPACK_IMPORTED_MODULE_5__["default"]).component;
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("g", { ref: hoverRef, onClick: onSelect, onContextMenu: editAccess ? onContextMenu : null, className: classnames__WEBPACK_IMPORTED_MODULE_1__('odc-operator-backed-service', {
        ...
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_console_topology__WEBPACK_IMPORTED_MODULE_2__["Layer"], { id: (dragging || labelDragging) && (regrouping || labelRegrouping) ? undefined : 'groups2' },
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("g", { ref: nodeRefs, className: classnames__WEBPACK_IMPORTED_MODULE_1__('odc-operator-backed-service', {
                ...
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("rect", { ref: dndDropRef, className: "odc-operator-backed-service__bg", x: x, y: y, width: width, height: height, rx: "5", ry: "5", filter: Object(_console_topology__WEBPACK_IMPORTED_MODULE_2__["createSvgIdUrl"])(hover || innerHover || contextMenuOpen || dragging || labelDragging
                        ? _components_NodeShadows__WEBPACK_IMPORTED_MODULE_7__["NODE_SHADOW_FILTER_ID_HOVER"]
                        : _components_NodeShadows__WEBPACK_IMPORTED_MODULE_7__["NODE_SHADOW_FILTER_ID"]) }),
                !hasChildren && (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("text", { x: x + width / 2, y: y + height / 2, dy: "0.35em", textAnchor: "middle" }, "No Resources")))),
...
const OperatorBackedServiceNode = ({ element, editAccess, selected, onSelect, onContextMenu, contextMenuOpen, dndDropRef, }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("g", { ref: refs, onClick: onSelect, onContextMenu: editAccess ? onContextMenu : null, className: classnames__WEBPACK_IMPORTED_MODULE_1__('odc-operator-backed-service', {
        ...
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("rect", { className: "odc-operator-backed-service__bg", filter: Object(_console_topology__WEBPACK_IMPORTED_MODULE_2__["createSvgIdUrl"])(hover || contextMenuOpen || dragging
                ? _components_NodeShadows__WEBPACK_IMPORTED_MODULE_6__["NODE_SHADOW_FILTER_ID_HOVER"]
                : _components_NodeShadows__WEBPACK_IMPORTED_MODULE_6__["NODE_SHADOW_FILTER_ID"]), x: 0, y: 0, width: width, height: height, rx: "5", ry: "5" }),
...
const CDRomModalFirehose = (props) => {
    ...
    const winToolsContainer = _constants__WEBPACK_IMPORTED_MODULE_7__["WINTOOLS_CONTAINER_NAMES"][window.SERVER_FLAGS.branding] || _constants__WEBPACK_IMPORTED_MODULE_7__["WINTOOLS_CONTAINER_NAMES"].okd;
    const resources = [
        {
...
/*!*************************************************************!*\
  !*** ./packages/kubevirt-plugin/src/selectors/vmi/index.ts ***!
  \*************************************************************/
/*! exports provided: getVMIDisks, getVMINetworks, getVMIVolumes, getVMIInterfaces, getVMIConditionsByType, isVMIRunning, getVMIAvailableStatusInterfaces, getVMINodeName, isVMIPaused, getVMINodeSelector, getVMITolerations, getVMIAffinity, findRDPService, getRdpConnectionDetails, getSerialConsoleConnectionDetails, getVncConnectionDetails, isGuestAgentConnected, getVMISubresourcePath, getVMIApiPath, getVmiIpAddresses */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
//# sourceMappingURL=dev-console-topology-ed6e1c3ba222a4d11650.js.map