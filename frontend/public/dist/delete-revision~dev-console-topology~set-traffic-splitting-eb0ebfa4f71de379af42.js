...
const SvgBoxedText = (_a) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("g", { className: className, ref: refs },
        ...
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("text", Object.assign({}, other, { ref: textRef, x: midX + iconSpace / 2, y: y, textAnchor: "middle", dy: "0.35em", onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave }), truncate > 0 ? (labelHover ? children : Object(_console_internal_components_utils__WEBPACK_IMPORTED_MODULE_2__["truncateMiddle"])(children, { length: truncate })) : children)));
};
...
const deleteGroup = (application) => {
    ...
    const resourceModel = Object(_console_internal_module_k8s__WEBPACK_IMPORTED_MODULE_1__["modelFor"])(primaryResource.kind) ? Object(_console_internal_module_k8s__WEBPACK_IMPORTED_MODULE_1__["modelFor"])(primaryResource.kind) : Object(_console_internal_module_k8s__WEBPACK_IMPORTED_MODULE_1__["modelFor"])(Object(_console_internal_module_k8s__WEBPACK_IMPORTED_MODULE_1__["referenceFor"])(primaryResource));
    return {
...
const graphDropTargetSpec = {
    ...
    collect: monitor => {
        ...
        const dragCreate = dragEditInProgress && (monitor.getItemType() === _console_topology__WEBPACK_IMPORTED_MODULE_2__["CREATE_CONNECTOR_DROP_TYPE"] || monitor.getItemType() === MOVE_CONNECTOR_DROP_TYPE);
        return {
            dragEditInProgress,
            dragCreate,
...
const applicationGroupDropTargetSpec = {
    accept: [NODE_DRAG_TYPE, EDGE_DRAG_TYPE, _console_topology__WEBPACK_IMPORTED_MODULE_2__["CREATE_CONNECTOR_DROP_TYPE"]],
    canDrop: (item, monitor) => { var _a; return monitor.isOver({ shallow: monitor.getItemType() === _console_topology__WEBPACK_IMPORTED_MODULE_2__["CREATE_CONNECTOR_DROP_TYPE"] }) && (((_a = monitor.getOperation()) === null || _a === void 0 ? void 0 : _a.type) === REGROUP_OPERATION || monitor.getItemType() === _console_topology__WEBPACK_IMPORTED_MODULE_2__["CREATE_CONNECTOR_DROP_TYPE"]); },
    collect: monitor => {
        var _a, _b, _c;
        return {
            ...
            canDrop: monitor.isDragging() && (((_b = monitor.getOperation()) === null || _b === void 0 ? void 0 : _b.type) === REGROUP_OPERATION || monitor.getItemType() === _console_topology__WEBPACK_IMPORTED_MODULE_2__["CREATE_CONNECTOR_DROP_TYPE"]),
...
const ObservedAggregateEdge = ({ element }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_console_topology__WEBPACK_IMPORTED_MODULE_2__["Layer"], { id: hover ? 'top' : undefined },
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("g", { ref: hoverRef, "data-test-id": "edge-handler", className: classnames__WEBPACK_IMPORTED_MODULE_1__('odc-base-edge odc-aggregate-edge', {
            ...
            !bidirectional && (!element.getSource().isCollapsed() || !element.getTarget().isCollapsed()) && react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_console_topology__WEBPACK_IMPORTED_MODULE_2__["EdgeConnectorArrow"], { edge: element }))));
};
...
const ObservedApplication = ({ element, selected, onSelect, dndDropRef, droppable, canDrop, dropTarget, dragRegroupable, onContextMenu, contextMenuOpen, dragging }) => {
    ...
    react__WEBPACK_IMPORTED_MODULE_0__["useEffect"](() => {
        ...
        if (needsHint !== needsHintRef.current) {
            ...
            element.getController().fireEvent(_topology_types__WEBPACK_IMPORTED_MODULE_2__["SHOW_GROUPING_HINT_EVENT"], element, needsHint ? react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_RegroupHint__WEBPACK_IMPORTED_MODULE_3__["RegroupHint"], null) : null);
        }
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("g", { ref: labelHoverRef, onContextMenu: onContextMenu, onClick: onSelect, className: classnames__WEBPACK_IMPORTED_MODULE_4__('odc-application-group', {
        ...
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_console_topology__WEBPACK_IMPORTED_MODULE_3__["Layer"], { id: "groups" },
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("g", { ref: refs, onContextMenu: onContextMenu, onClick: onSelect, className: classnames__WEBPACK_IMPORTED_MODULE_4__('odc-application-group', {
                ...
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("path", { ref: dndDropRef, className: "odc-application-group__bg", filter: Object(_console_topology__WEBPACK_IMPORTED_MODULE_3__["createSvgIdUrl"])(hover || labelHover || dragging || contextMenuOpen || dropTarget ? _NodeShadows__WEBPACK_IMPORTED_MODULE_7__["NODE_SHADOW_FILTER_ID_HOVER"] : _NodeShadows__WEBPACK_IMPORTED_MODULE_7__["NODE_SHADOW_FILTER_ID"]), d: pathRef.current }))),
...
const ApplicationNode = ({ element, selected, onSelect, dndDropRef, canDrop, dropTarget, onContextMenu, contextMenuOpen, dragging }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("g", { ref: refs, onContextMenu: onContextMenu, onClick: onSelect, className: classnames__WEBPACK_IMPORTED_MODULE_2__('odc-application-group', {
        ...
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("rect", { ref: dndDropRef, filter: Object(_console_topology__WEBPACK_IMPORTED_MODULE_3__["createSvgIdUrl"])(hover || dragging || contextMenuOpen || dropTarget ? _NodeShadows__WEBPACK_IMPORTED_MODULE_5__["NODE_SHADOW_FILTER_ID_HOVER"] : _NodeShadows__WEBPACK_IMPORTED_MODULE_5__["NODE_SHADOW_FILTER_ID"]), className: "odc-application-group__bg", x: 0, y: 0, width: width, height: height, rx: "5", ry: "5" }),
...
const ObservedBaseNode = ({ className, outerRadius, innerRadius, icon, kind, element, selected, onSelect, children, attachments, dragNodeRef, dndDropRef, canDrop, dragging, edgeDragging, dropTarget, onHideCreateConnector, onShowCreateConnector, onContextMenu, contextMenuOpen }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("g", { className: classnames__WEBPACK_IMPORTED_MODULE_1__('odc-base-node', className, {
        ...
        react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("g", { "data-test-id": "base-node-handler", onClick: onSelect, onContextMenu: editAccess ? onContextMenu : null, ref: refs },
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("circle", { className: "odc-base-node__bg", ref: dndDropRef, cx: cx, cy: cy, r: outerRadius, filter: Object(_console_topology__WEBPACK_IMPORTED_MODULE_2__["createSvgIdUrl"])(hover || dragging || edgeDragging || dropTarget || contextMenuOpen ? _NodeShadows__WEBPACK_IMPORTED_MODULE_8__["NODE_SHADOW_FILTER_ID_HOVER"] : _NodeShadows__WEBPACK_IMPORTED_MODULE_8__["NODE_SHADOW_FILTER_ID"]) }),
...
const topologyModelFromDataModel = (dataModel, application = _console_shared_src__WEBPACK_IMPORTED_MODULE_1__["ALL_APPLICATIONS_KEY"], filters) => {
    const groupNodes = dataModel.graph.groups.map(d => {
        ...
        return {
            ...
            group: true,
            type: d.type,
            visible: d.type !== _components_const__WEBPACK_IMPORTED_MODULE_6__["TYPE_APPLICATION_GROUP"] || application === _console_shared_src__WEBPACK_IMPORTED_MODULE_1__["ALL_APPLICATIONS_KEY"] || d.name === application,
...
const createTopologyNodeData = (dc, type, defaultIcon, operatorBackedService = false) => {
    ...
    const builderImageIcon = Object(_console_internal_components_catalog_catalog_item_icon__WEBPACK_IMPORTED_MODULE_3__["getImageForIconClass"])(`icon-${deploymentsLabels['app.openshift.io/runtime']}`) || Object(_console_internal_components_catalog_catalog_item_icon__WEBPACK_IMPORTED_MODULE_3__["getImageForIconClass"])(`icon-${deploymentsLabels['app.kubernetes.io/name']}`);
    return {
        id: dcUID,
        ...
        data: {
            ...
            isKnativeResource: type && (type === _console_knative_plugin_src_topology_const__WEBPACK_IMPORTED_MODULE_4__["TYPE_EVENT_SOURCE"] || type === _console_knative_plugin_src_topology_const__WEBPACK_IMPORTED_MODULE_4__["TYPE_KNATIVE_REVISION"]) ? true : Object(_console_shared__WEBPACK_IMPORTED_MODULE_2__["isKnativeServing"])(deploymentConfig, 'metadata.labels'),
...
const useSearchFilter = (text) => {
    ...
    const filtered = react__WEBPACK_IMPORTED_MODULE_0__["useMemo"](() => fuzzyCaseInsensitive(searchQuery, text), [searchQuery, text]);
...
const filterNonKnativeDeployments = (resources, eventSources) => {
    ...
    return lodash__WEBPACK_IMPORTED_MODULE_0__["filter"](resources, d => {
        var _a, _b;
        return !lodash__WEBPACK_IMPORTED_MODULE_0__["get"](d, ['metadata', 'labels', KNATIVE_CONFIGURATION], false) && !isEventSourceKind((_b = (_a = d.metadata) === null || _a === void 0 ? void 0 : _a.ownerReferences) === null || _b === void 0 ? void 0 : _b[0].uid);
    });
};
...
const EnvironmentPage = props => react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_utils__WEBPACK_IMPORTED_MODULE_7__["AsyncComponent"], Object.assign({ loader: () => __webpack_require__.e(/*! import() */ 9).then(__webpack_require__.bind(null, /*! ./environment.jsx */ "./public/components/environment.jsx")).then(c => c.EnvironmentPage) }, props));
...
const EnvironmentPage = props => react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_utils__WEBPACK_IMPORTED_MODULE_11__["AsyncComponent"], Object.assign({ loader: () => __webpack_require__.e(/*! import() */ 9).then(__webpack_require__.bind(null, /*! ./environment.jsx */ "./public/components/environment.jsx")).then(c => c.EnvironmentPage) }, props));
const envPath = ['spec', 'template', 'spec', 'containers'];
...
const EnvironmentPage = props => react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_utils__WEBPACK_IMPORTED_MODULE_8__["AsyncComponent"], Object.assign({ loader: () => __webpack_require__.e(/*! import() */ 9).then(__webpack_require__.bind(null, /*! ./environment.jsx */ "./public/components/environment.jsx")).then(c => c.EnvironmentPage) }, props));
const envPath = ['spec', 'template', 'spec', 'containers'];
const EnvironmentTab = props => react__WEBPACK_IMPORTED_MODULE_0__["createElement"](EnvironmentPage, { obj: props.obj, rawEnvData: props.obj.spec.template.spec, envPath: envPath, readOnly: false });
...
//# sourceMappingURL=delete-revision~dev-console-topology~set-traffic-splitting-eb0ebfa4f71de379af42.js.map